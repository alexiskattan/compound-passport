...
exports.redirectOnSuccess = function redirectOnSuccess(req, res, next) {
    // var redir = '/';
    var redir = '/administrators/' + req.user.id;
    console.log("yooooo123")
...
exports.init = function (compound) {
    ...
    compound.on('models', function(models) {
        if (models.Administrator) {
            exports.loadAdministrator(models.Administrator);
        }
    });
    ...
    passport.deserializeUser(function deserializeUser(userId, done) {
        exports.Administrator.find(userId, function (err, administrator) {
...
exports.loadAdministrator = function (u) {
    Object.keys(exports.strategies).forEach(function (str) {
        exports.strategies[str].Administrator = u;
    });
    exports.Administrator = u;
};
